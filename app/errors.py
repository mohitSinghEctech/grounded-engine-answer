...
class UpstreamTimeout(AppError):
    def __init__(
        self,
        message: str = "The upstream LLM service timed out"
    ):
        super().__init__(
...
class UpstreamUnavailable(AppError):
    def __init__(
        self,
        message: str = "The upstream LLM service is unavailable"
    ):
        super().__init__(
...
class InvalidUpstreamResponse(AppError):
    def __init__(
        self,
        message: str = "The upstream LLM service returned an invalid response"
    ):
        super().__init__(
